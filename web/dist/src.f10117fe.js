...
/** @class */
function () {
  function Model(atributtes, events, sync) {
    this.atributtes = atributtes;
    this.events = events;
    this.sync = sync;
    this.on = this.events.on;
    this.get = this.atributtes.get;
  ...
  Model.prototype.save = function () {
    ...
    this.sync.save(this.atributtes.getAll()).then(function (response) {
      _this.trigger("save");
    }).catch(function () {
      _this.trigger("error");
    });
...
exports.Model = Model;
},{}],"src/models/Atributtes.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Atributtes = void 0;

var Atributtes =
/** @class */
function () {
  function Atributtes(data) {
    var _this = this;
  ...
  Atributtes.prototype.set = function (update) {
    Object.assign(this.data, update);
  };

  Atributtes.prototype.getAll = function () {
    return this.data;
  };
...
exports.Atributtes = Atributtes;
var attrs = new Atributtes({
  id: 5,
  name: "Nameeee",
  age: 25
});
...
var Atributtes_1 = require("./Atributtes");
...
function (_super) {
  ...
  User.buildUser = function (attrs) {
    return new User(new Atributtes_1.Atributtes(attrs), new Eventing_1.Eventing(), new Sync_1.ApiSync(rootUrl));
  };
...
exports.User = User;
},{"./Model":"src/models/Model.ts","./Atributtes":"src/models/Atributtes.ts","./Sync":"src/models/Sync.ts","./Eventing":"src/models/Eventing.ts","./Collection":"src/models/Collection.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
