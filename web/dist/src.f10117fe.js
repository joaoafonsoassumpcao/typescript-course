...
exports.Sync = Sync;
},{"axios":"node_modules/axios/index.js"}],"src/models/Atributtes.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function User(attrs) {
    ...
    this.atributtes = new Atributtes_1.Atributtes(attrs);
  }
...
exports.User = User;
},{"./Eventing":"src/models/Eventing.ts","./Sync":"src/models/Sync.ts","./Atributtes":"src/models/Atributtes.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
